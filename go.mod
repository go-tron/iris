module github.com/go-tron/iris
...
require (
	...
	github.com/go-tron/rate-limiter v1.0.0
	github.com/go-tron/types v1.0.0
	github.com/go-tron/validate v1.0.0
...
require (
	...
	github.com/go-tron/redis v1.0.0 // indirect
